...
const { validateGetTransferStatusSchema } = require('../../../src/utils/validateSchema');
const get_transfer_status_schema = require('../../../src/schema/api_input/get_transfer_status.json');
...
describe('test validate get_transfer_status_schema', () => {
  ...
  it('should validate failed if transfer_id is not valid', () => {
    const data = {};
    const valid = validateGetTransferStatusSchema(data, get_transfer_status_schema);
    ...
    const valid1 = validateGetTransferStatusSchema(data, get_transfer_status_schema);
    ...
    data.transfer_id = '';
    const valid2 = validateGetTransferStatusSchema(data, get_transfer_status_schema);
    ...
    const valid3 = validateGetTransferStatusSchema(data, get_transfer_status_schema);
