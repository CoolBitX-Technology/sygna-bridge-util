...
describe('test validate post_permission_schema', () => {
  ...
  it('should generate correct schema', () => {
    ...
    expect(post_permission_schema).toEqual(genPostPermissionSchema({}));
    expect(post_permission_schema).toEqual(
      genPostPermissionSchema({ permission_status }),
    );
  ...
  it('should validate failed if transfer_id is not valid', () => {
    ...
    data.transfer_id = '';
    const valid1 = validatePostPermissionSchema(data);
    ...
    const valid2 = validatePostPermissionSchema(data);
  ...
  it('should validate failed if signature is not valid', () => {
    ...
    data.signature = '';
    const valid3 = validatePostPermissionSchema(data);
    ...
    const valid4 = validatePostPermissionSchema(data);
    ...
    const valid5 = validatePostPermissionSchema(data);
