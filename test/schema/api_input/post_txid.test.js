...
const post_txid_schema = require('../../../src/schema/api_input/post_txid.json');
...
describe('test validate post_txid_schema', () => {
  ...
  it('should validate failed if transfer_id is not valid', () => {
    const data = {};
    const valid = validatePostTxIdSchema(data, post_txid_schema);
    ...
    const valid1 = validatePostTxIdSchema(data, post_txid_schema);
    ...
    data.transfer_id = '';
    const valid2 = validatePostTxIdSchema(data, post_txid_schema);
    ...
    const valid3 = validatePostTxIdSchema(data, post_txid_schema);
  ...
  it('should validate failed if signature is not valid', () => {
    ...
    const valid4 = validatePostTxIdSchema(data, post_txid_schema);
    ...
    const valid5 = validatePostTxIdSchema(data, post_txid_schema);
