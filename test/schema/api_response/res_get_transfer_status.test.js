...
const { validateResGetTransferStatusSchema } = require('../../../src/utils/validateSchema');
const res_get_transfer_status_schema = require('../../../src/schema/api_response/res_get_transfer_status.json');
...
describe('test validate res_get_transfer_status_schema', () => {
  ...
  const permission_request_data_signature = '6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b';
  const permission_signature = '6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b';
  const txid = '123';
  const txid_signature = '6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b';
  ...
  it('should validate failed if transferData is not valid', () => {
    const data = {};
    const valid = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    ...
    const valid1 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    ...
    data.transferData = '';
    const valid2 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
  ...
  it('should validate failed if transferData.transfer_id is not valid', () => {
    ...
    data.transferData.transfer_id = '6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b1';
    const valid2 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid2[0]).toBe(false);
    const { dataPath: dataPath2, message: message2 } = valid2[1][0];
  ...
  it('should validate failed if transferData.private_info is not valid', () => {
    ...
    const valid3 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
  ...
  it('should validate failed if transferData.transaction.originator_addrs is not valid', () => {
    ...
    const valid4 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
  ...
  it('should validate failed if transferData.transaction.beneficiary_vasp_code is not valid', () => {
    ...
    expect(valid1[0]).toBe(false);
    const { dataPath: dataPath1, message: message1 } = valid1[1][0];
    expect(dataPath1).toEqual('.transferData.transaction.beneficiary_vasp_code');
    expect(message1).toEqual('should be string');
    ...
    expect(valid2[0]).toBe(false);
    const { dataPath: dataPath2, message: message2 } = valid2[1][0];
    expect(dataPath2).toEqual('.transferData.transaction.beneficiary_vasp_code');
    expect(message2).toEqual('should NOT be shorter than 1 characters');
  });
  ...
  it('should validate failed if transferData.transaction.originator_addrs_extra is not valid', () => {
    ...
    expect(valid[0]).toBe(false);
    const { dataPath, message } = valid[1][0];
    expect(dataPath).toEqual('.transferData.transaction.originator_addrs_extra');
    ...
    expect(valid1[0]).toBe(false);
    const { dataPath: dataPath1, message: message1 } = valid1[1][0];
    expect(dataPath1).toEqual('.transferData.transaction.originator_addrs_extra');
  ...
  it('should validate failed if transferData.transaction.beneficiary_addrs_extra is not valid', () => {
    ...
    expect(valid[0]).toBe(false);
    const { dataPath, message } = valid[1][0];
    expect(dataPath).toEqual('.transferData.transaction.beneficiary_addrs_extra');
    expect(message).toEqual('should be object');
    ...
    expect(valid1[0]).toBe(false);
    const { dataPath: dataPath1, message: message1 } = valid1[1][0];
    expect(dataPath1).toEqual('.transferData.transaction.beneficiary_addrs_extra');
    expect(message1).toEqual('should NOT have fewer than 1 properties');
  });
  ...
  it('should validate failed if transferData.permission_request_data_signature is not valid', () => {
    ...
    const { dataPath, message } = valid[1][0];
    expect(dataPath).toEqual('.transferData');
    expect(message).toEqual('should have required property \'permission_request_data_signature\'');

    data.transferData.permission_request_data_signature = 0;
    const valid2 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid2[0]).toBe(false);
    const { dataPath: dataPath2, message: message2 } = valid2[1][0];
    expect(dataPath2).toEqual('.transferData.permission_request_data_signature');
    ...
    expect(valid3[0]).toBe(false);
    const { dataPath: dataPath3, message: message3 } = valid3[1][0];
    expect(dataPath3).toEqual('.transferData.permission_request_data_signature');
    expect(message3).toEqual('should NOT be shorter than 128 characters');

    data.transferData.permission_request_data_signature = '6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b1';
    const valid4 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid4[0]).toBe(false);
    const { dataPath: dataPath4, message: message4 } = valid4[1][0];
    expect(dataPath4).toEqual('.transferData.permission_request_data_signature');
    expect(message4).toEqual('should NOT be longer than 128 characters');

    data.transferData.permission_request_data_signature = '6b86b273ff34fce19d6b804egg5a3f5747ada4eaa22f1d49c01e52ddb7875b4b6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b';
    const valid5 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid5[0]).toBe(false);
    const { dataPath: dataPath5, message: message5 } = valid5[1][0];
    expect(dataPath5).toEqual('.transferData.permission_request_data_signature');
    expect(message5).toEqual('should match pattern \"^[0123456789A-Fa-f]+$\"');

    data.transferData.permission_request_data_signature = null;
    const valid6 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid6[0]).toBe(false);
    const { dataPath: dataPath6, message: message6 } = valid6[1][0];
    expect(dataPath6).not.toBe('.transferData.permission_request_data_signature');
  ...
  it('should validate failed if transferData.permission_signature is not valid', () => {
    ...
    const { dataPath, message } = valid[1][0];
    expect(dataPath).toEqual('.transferData');
    expect(message).toEqual('should have required property \'permission_signature\'');
    ...
    data.transferData.permission_signature = '6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b1';
    const valid4 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid4[0]).toBe(false);
    const { dataPath: dataPath4, message: message4 } = valid4[1][0];
    ...
    data.transferData.permission_signature = '6b86b273ff34fce19d6b804egg5a3f5747ada4eaa22f1d49c01e52ddb7875b4b6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b';
    const valid5 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid5[0]).toBe(false);
    const { dataPath: dataPath5, message: message5 } = valid5[1][0];
  ...
  it('should validate failed if transferData.txid_signature is not valid', () => {
    ...
    data.transferData.txid_signature = '6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b1';
    const valid4 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid4[0]).toBe(false);
    const { dataPath: dataPath4, message: message4 } = valid4[1][0];
    ...
    data.transferData.txid_signature = '6b86b273ff34fce19d6b804egg5a3f5747ada4eaa22f1d49c01e52ddb7875b4b6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b';
    const valid5 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid5[0]).toBe(false);
    const { dataPath: dataPath5, message: message5 } = valid5[1][0];
  ...
  it('should validate failed if transferData.transfer_to_originator_time is not valid', () => {
    ...
    const { dataPath, message } = valid[1][0];
    expect(dataPath).toEqual('.transferData');
    expect(message).toEqual('should have required property \'transfer_to_originator_time\'');
  ...
  it('should validate success', () => {
    ...
    data.transferData.permission_signature = null;
    const valid7 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid7[0]).toBe(true);

    data.transferData.txid = null;
    const valid8 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid8[0]).toBe(true);

    data.transferData.txid_signature = null;
    const valid9 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid9[0]).toBe(true);

    data.transferData.created_at = null;
    const valid10 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
    expect(valid10[0]).toBe(true);

    data.transferData.transfer_to_originator_time = null;
    const valid11 = validateResGetTransferStatusSchema(data, res_get_transfer_status_schema);
