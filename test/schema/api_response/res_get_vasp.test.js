...
describe('test validate res_get_vasp', () => {
  ...
  it('should validate failed if vasp_data is not valid', () => {
    ...
    const valid = validateResGetVaspSchema(data);
    ...
    data.vasp_data = 123;
    const valid1 = validateResGetVaspSchema(data);
    ...
    data.vasp_data = [];
    const valid2 = validateResGetVaspSchema(data);
    ...
    const valid3 = validateResGetVaspSchema(data);
  ...
  it('should validate failed if signature is not valid', () => {
    ...
    const valid4 = validateResGetVaspSchema(data);
    ...
    const valid5 = validateResGetVaspSchema(data);
