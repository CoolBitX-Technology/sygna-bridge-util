...
describe('test validate res_retry_schema', () => {
  ...
  it('should validate failed if retryItems is not valid', () => {
    const data = {};
    const valid = validateResRetrySchema(data);
    ...
    data.retryItems = '123';
    const valid1 = validateResRetrySchema(data);
    ...
    data.retryItems = '';
    const valid2 = validateResRetrySchema(data);
    ...
    data.retryItems = -1;
    const valid3 = validateResRetrySchema(data);
