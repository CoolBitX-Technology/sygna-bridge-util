const { validatePermissionRequestSchema } = require('../../../src/utils/validateSchema');
const permission_request_schema = require('../../../src/schema/data/permission_request.json');
...
describe('test validate permission_request_schema', () => {
  ...
  it('should validate failed if private_info is not valid', () => {
    const data = {};
    const valid = validatePermissionRequestSchema(data, permission_request_schema);
    ...
    const valid1 = validatePermissionRequestSchema(data, permission_request_schema);
  ...
  it('should validate failed if transaction.originator_addrs is not valid', () => {
    ...
    const valid3 = validatePermissionRequestSchema(data, permission_request_schema);
    ...
    const valid4 = validatePermissionRequestSchema(data, permission_request_schema);
