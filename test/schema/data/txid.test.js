...
const txid_schema = require('../../../src/schema/data/txid.json');
...
describe('test validate txid_schema', () => {
  ...
  it('should validate failed if transfer_id is not valid', () => {
    const data = {};
    const valid = validateTxIdSchema(data, txid_schema);
    ...
    data.transfer_id = '';
    const valid1 = validateTxIdSchema(data, txid_schema);
    ...
    const valid2 = validateTxIdSchema(data, txid_schema);
