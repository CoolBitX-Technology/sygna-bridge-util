...
describe('test sortData', () => {
  ...
  describe('test sortTxIdData', () => {
    it('should return sorted data', () => {
      ...
      expect(JSON.stringify(sortTxIdData(fakeData))).toBe(
        JSON.stringify({
  ...
  describe('test sortPermissionData', () => {
    it('should return sorted data', () => {
      ...
      expect(JSON.stringify(sortPermissionData(fakeData))).toBe(
        JSON.stringify({
          transfer_id: fakeData.transfer_id,
  ...
  describe('test sortPermissionRequestData', () => {
    it('should return sorted data', () => {
      ...
      expect(JSON.stringify(sortPermissionRequestData(fakeData))).toBe(
        JSON.stringify({
        ...
        JSON.stringify({
          ...
          transaction: {
            ...
            beneficiary_addrs_extra:
              fakeData.transaction.beneficiary_addrs_extra,
            transaction_currency: fakeData.transaction.transaction_currency,
            amount: fakeData.transaction.amount,
          },
          data_dt: fakeData.data_dt,
  ...
  describe('test sortPostTransactionIdData', () => {
    it('should return sorted data', () => {
      ...
      expect(JSON.stringify(sortPostTransactionIdData(fakeData))).toBe(
        JSON.stringify({
          transfer_id: fakeData.transfer_id,
          txid: fakeData.txid,
  ...
  describe('test sortPostPermissionData', () => {
    it('should return sorted data', () => {
      ...
      expect(JSON.stringify(sortPostPermissionData(fakeData))).toBe(
        JSON.stringify({
          transfer_id: fakeData.transfer_id,
          permission_status: fakeData.permission_status,
          signature: fakeData.signature,
          ...
          data: {
            ...
            transaction: {
              ...
              originator_addrs_extra:
                fakeData.data.transaction.originator_addrs_extra,
              beneficiary_vasp_code:
                fakeData.data.transaction.beneficiary_vasp_code,
              beneficiary_addrs: fakeData.data.transaction.beneficiary_addrs,
              transaction_currency:
        ...
        JSON.stringify({
          data: {
            ...
            transaction: {
              ...
              beneficiary_addrs: fakeData.data.transaction.beneficiary_addrs,
              beneficiary_addrs_extra:
                fakeData.data.transaction.beneficiary_addrs_extra,
              transaction_currency:
                fakeData.data.transaction.transaction_currency,
              amount: fakeData.data.transaction.amount,
            },
